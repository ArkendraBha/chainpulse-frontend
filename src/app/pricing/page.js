...
const TIERS = {
  ...
  "CSV export — exposure log and performance data",
  ...
  "Backtesting engine — 5 strategies, up to 365 days",
...
{[
  ...
  { feat: "On-chain metrics (funding rates + open interest)", free: false, essential: true, pro: true, institutional: true },
  { feat: "CSV export (exposure + performance)",           free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Email alerts + daily brief",                    free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Volatility & liquidity environment",            free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Regime maturity + countdown timer",             free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Stress meter + confidence score",               free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Exposure calibration engine",                   free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Drawdown simulator",                            free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "PnL impact estimator",                          free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Consequence simulator",                         free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Risk profile calibration",                      free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Exposure logger",                               free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Discipline score + streak tracking",            free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Mistake replay engine",                         free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Performance comparison vs model",               free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Edge profile by regime",                        free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Weekly performance report",                     free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Regime calendar (daily history)",               free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Portfolio health score",                        free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Transition probability matrix",                 free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Cross-asset correlation monitor",               free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "Portfolio exposure allocator",                  free: false, essential: true,  pro: true,  institutional: true  },
  { feat: "All 7 assets tracked",                          free: false, essential: true,  pro: true,  institutional: true  },

  // ─── Pro features ───
  { feat: "WebSocket live regime streaming",               free: false, essential: false, pro: true,  institutional: true  },
  { feat: "AI Regime Analyst narrative",                   free: false, essential: false, pro: true,  institutional: true  },
  ...
  { feat: "Setup quality scoring + entry zones",           free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Probabilistic scenarios (Bull/Base/Bear)",      free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Trade plan generator with tranches + stops",    free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Internal damage monitor",                       free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Event risk overlay",                            free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Behavioral alpha leak detection",               free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Historical analog matching",                    free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Opportunity ranking (cross-asset)",             free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Comparison mode (side-by-side assets)",         free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Alert inbox (evaluated thresholds)",            free: false, essential: false, pro: true,  institutional: true  },
  { feat: "Enhanced on-chain intelligence",                free: false, essential: false, pro: true,  institutional: true  },

  // ─── Institutional features ───
  { feat: "REST API access (1,000 req/day)",               free: false, essential: false, pro: false, institutional: true  },
  { feat: "Up to 3 API keys with usage tracking",          free: false, essential: false, pro: false, institutional: true  },
  { feat: "Webhook delivery + HMAC signatures",            free: false, essential: false, pro: false, institutional: true  },
  { feat: "Up to 5 webhook endpoints",                     free: false, essential: false, pro: false, institutional: true  },
  { feat: "Delivery logs with retry status",               free: false, essential: false, pro: false, institutional: true  },
  { feat: "Custom per-coin alert thresholds",              free: false, essential: false, pro: false, institutional: true  },
  { feat: "Custom regime thresholds (score boundaries)",   free: false, essential: false, pro: false, institutional: true  },
  { feat: "Trader archetype overlay",                      free: false, essential: false, pro: false, institutional: true  },
  { feat: "Priority alert delivery (1hr cooldown)",        free: false, essential: false, pro: false, institutional: true  },
].map((row) => (
