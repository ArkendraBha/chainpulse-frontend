...
function getRegimeGlow(label) {
  if (!label) return "";
  if (label.includes("Risk-On")) return "shadow-[0_0_120px_rgba(16,185,129,0.08)]";
  if (label.includes("Risk-Off")) return "shadow-[0_0_120px_rgba(239,68,68,0.08)]";
  return "shadow-[0_0_120px_rgba(234,179,8,0.06)]";
}
...
export default function Landing() {
  ...
  return (
    <main className="min-h-screen text-white overflow-x-hidden" style={{ backgroundColor: "#080809" }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8 z-10">
          ...
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2.5 border border-white/8 rounded-full px-4 py-1.5 text-xs text-zinc-500 uppercase tracking-widest">
          ...
          {/* Headline */}
          <h1
            className="text-6xl sm:text-7xl md:text-8xl font-semibold leading-none tracking-tight"
            style={{ letterSpacing: "-0.03em" }}
          >
            Allocate capital<br />
            <span style={{ color: "#71717a" }}>with precision.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            <Link
              href="/app"
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl text-sm font-semibold text-black transition-all hover:-translate-y-[1px] hover:shadow-xl"
            ...
            <Link
              href="/methodology"
              className="inline-flex items-center justify-center px-7 py-3.5 rounded-xl text-sm font-medium text-zinc-400 border border-white/8 hover:border-white/15 hover:text-white transition-all"
          ...
          {/* Trust micro-line */}
          <div className="flex items-center justify-center gap-6 text-xs text-zinc-700 pt-2">
        ...
        <div className="relative w-full max-w-5xl mx-auto mt-16 z-10">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 0 1px rgba(255,255,255,0.04), 0 40px 120px rgba(0,0,0,0.8), 0 0 80px rgba(16,185,129,0.06)",
            }}
          >
            {/* Fake browser chrome */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5">
              ...
              <div className="flex-1 flex justify-center">
                <div className="text-[10px] text-zinc-600 border border-white/5 rounded-md px-3 py-0.5">
                  chainpulse.pro/app
                </div>
              </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 overflow-hidden">
                {[
                  ...
                  <div
                    key={coin}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/5 shrink-0"
              ...
              {/* Hero regime bar mockup */}
              <div
                className="rounded-xl border border-red-900/40 p-5"
                style={{ background: "linear-gradient(to right, rgba(239,68,68,0.08), transparent)" }}
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    <div className="text-[10px] text-zinc-500 uppercase tracking-widest">Current Regime</div>
                ...
                <div className="mt-4 flex gap-2">
                  {[
                    { label: "Macro (1D)", regime: "Strong Risk-Off", color: "border-red-800/60 bg-red-950/30 text-red-400" },
                    { label: "Trend (4H)", regime: "Strong Risk-Off", color: "border-red-800/60 bg-red-950/30 text-red-400" },
                    { label: "Execution (1H)", regime: "Risk-Off", color: "border-red-900/40 bg-red-950/20 text-red-400" },
                  ].map(({ label: l, regime, color }) => (
                    <div key={l} className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs ${color}`}>
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                {[
                  { label: "Survival", value: "34%", color: "text-yellow-400" },
                  { label: "Shift Risk", value: "71.6%", color: "text-red-400" },
                  { label: "Hazard Rate", value: "68%", color: "text-orange-400" },
                  ...
                  <div
                    key={l}
                    className="rounded-lg p-3 space-y-1 border border-white/5"
                    style={{ backgroundColor: "rgba(255,255,255,0.02)" }}
                  >
      ...
      {/* ── HOW IT WORKS ── */}
      <section className="px-6 py-28 border-t border-white/4">
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="text-center space-y-3">
            ...
            <p className="text-zinc-500 text-sm max-w-lg mx-auto leading-relaxed">
              Four analytical layers. One systematic output. No interpretation required.
            </p>
          </div>

          <div className="grid md:grid-cols-4 gap-px" style={{ backgroundColor: "rgba(255,255,255,0.04)" }}>
            {[
              {
                n: "01",
                title: "Regime Classification",
                desc: "Multi-timeframe momentum and volatility scoring classifies market state across macro, trend, and execution layers.",
              },
              {
                n: "02",
                title: "Coherence Measurement",
                desc: "Alignment across timeframes distinguishes high-conviction regimes from transitional noise.",
              },
              {
                n: "03",
                title: "Survival Modeling",
                desc: "Historical regime durations generate conditional persistence probabilities. How much statistical life remains?",
              },
              {
                n: "04",
                title: "Exposure Output",
                desc: "A single allocation recommendation calibrated to strength, persistence, hazard rate, and alignment.",
              },
            ].map(({ n, title, desc }) => (
              <div
                key={n}
              ...
              >
                <div className="text-[10px] text-zinc-700 uppercase tracking-widest font-mono">{n}</div>
      ...
      {/* ── LIVE SNAPSHOT ── */}
      <section className="px-6 py-20 border-t border-white/4">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div
            className={`rounded-2xl border p-8 transition-all duration-700 ${
              label
                ? label.includes("Risk-Off")
                  ? "border-red-900/40"
              ...
              <div className="space-y-6">
                  ...
                  {[
                    {
                      ...
                      color:
                        ...
                        shiftRisk > 45 ? "text-yellow-400" : "text-emerald-400",
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/5">
                  <div className="text-xs text-zinc-700">
                    Exposure recommendation and directive available in dashboard
                  </div>
                  <Link
                    href="/app"
            ...
            {[
              {
                icon: "↗",
                title: "Swing traders",
                desc: "Holding positions 2–30 days. Need to know when to press size and when to stand down — not which coin to buy.",
              },
              {
                icon: "⊕",
                title: "Active allocators",
                desc: "Managing $25k–$500k+ across multiple assets. Want a systematic exposure framework, not more opinions.",
              },
              {
                icon: "◎",
              ...
              <div
                key={title}
                className="p-7 rounded-2xl border border-white/5 space-y-4 hover:border-white/10 transition-colors"
                style={{ backgroundColor: "#0f0f10" }}
              >
                <div className="text-xl text-zinc-500 font-mono">{icon}</div>
                <div className="text-sm font-semibold text-white">{title}</div>
                <p className="text-xs text-zinc-600 leading-relaxed">{desc}</p>
              </div>
            ))}
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <div
                key={l}
                className="flex items-start gap-4 p-5 rounded-xl border border-white/5 hover:border-white/8 transition-colors"
                style={{ backgroundColor: "#0f0f10" }}
              >
...
<section className="px-6 py-24 border-t border-white/4">
  <div className="max-w-4xl mx-auto space-y-10">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
      ...
      <section className="px-6 py-24 border-t border-white/4">
        <div className="max-w-lg mx-auto text-center space-y-6">
          ...
          {!subscribed ? (
            <div className="space-y-2">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl text-sm text-white placeholder-zinc-700 border border-white/8 focus:outline-none focus:border-white/20 transition-colors"
                  style={{ backgroundColor: "#111113" }}
                />
                <button
                  onClick={handleSubscribe}
                  className="px-5 py-3 rounded-xl text-sm font-semibold text-black transition-all hover:-translate-y-[1px]"
                  style={{ backgroundColor: "#10b981" }}
                >
                  Subscribe
                </button>
            ...
            <div
              className="border border-emerald-900/40 rounded-xl px-6 py-4 text-emerald-400 text-sm"
      ...
      {/* ── FOOTER ── */}
      <footer className="px-6 py-10 border-t border-white/4">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            <div
              className="w-5 h-5 rounded-md flex items-center justify-center"
              style={{ backgroundColor: "rgba(16,185,129,0.15)", border: "1px solid rgba(16,185,129,0.2)" }}
            >
