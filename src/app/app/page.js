  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-16">
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* stress meter + countdown — side by side */}
        <div className="grid md:grid-cols-2 gap-4">
          <StressMeter
            stack={stack}
            isPro={isPro}
        ...
        {/* quality + confidence trend — side by side */}
        <div className="grid md:grid-cols-2 gap-4">
          <RegimeQualityCard
            stack={stack}
            isPro={isPro}
        ...
        {/* playbook — full width, highest value */}
        <RegimePlaybook
          stack={stack}
          isPro={isPro}
          onUnlock={() => setShowModal(true)}
        ...
        {!isPro && (
          ...
          >
            ...
            <p className="text-gray-400 max-w-xl mx-auto text-sm">
              ...
              exposure tracker, regime countdown, confidence trend, and more.
            </p>
